...
# $Id: e23588838b4e28f9f10ad6575f5ecb975d9005bb $
# ---
...
# Silisizer: only provide the package if the statically-linked C library
# (Tclreadline_Init) has not already provided it. This avoids a "conflicting
# versions" error when the compiled-in library version differs from the value
# substituted into this script (e.g. the v2.4.1 release reports 2.4.0).
